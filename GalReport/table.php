...
if(isset($_POST["submit"]))
{
          ...
          $txtord = $filesop[2];
          $txtqntb = $filesop[3];
          $sql = "insert into gal_report (DPROD, DORD, DQNTB,DOPR) values
           ('".$txtprod."','".$txtord."','".$txtqntb."','".$txtopr."')";
...
$(document).ready(function(){
 ...
 // Append table with add row form on add new button click
  ...
  var index = $("table tbody tr:last-child").index();
        var row = '<tr>' +
            '<td><input type="text" class="form-control" name="DPROD" id="DPROD"></td>' +
            '<td><input type="text" class="form-control" name="DORD" id="DORD"></td>' +
            '<td><input type="text" class="form-control" name="DQNTB" id="DQNTB"></td>' +
            '<td><input type="text" class="form-control" name="DOPR" id="DOPR"></td>' +
 ...
 $(document).on("click", ".add", function(){
  ...
  var txtprod = $("#DPROD").val();
  var txtord = $("#DORD").val();
  var txtqntb = $("#DQNTB").val();
  var txtname = $("#DOPR").val();
  var date = $("#last_date").val();

  $.post("add.php", { txtprod: txtprod, txtord: txtord, txtqntb: txtqntb,txtname:txtname,date:date}, function(data) {
 ...
 $(document).on("click", ".update", function(){
  ...
  var txtord = $("#txtord").val();
  var txtqntb = $("#txtqntb").val();
  var txtname = $("#txtname").val();
  var date = $("#date").val();
  $.post("update.php", { string: string,txtprod: txtprod, txtord: txtord, txtqntb: txtqntb,txtname:txtname,date:date}, function(data) {
   $("#displaymessage").html(data);
  });
  location.reload();
...
<body>
    <div class="container"><p><h1 align="center">Gal Report</h1><div id="displaymessage"></div></p>
   ...
   <table class="table table-bordered" id="myTable">
                <thead>
                    <tr>
                        ...
                        <th>OPR</th>
                        <th>Update date</th>
                        <th><form method="post" action="export.php">
...
<?php 
include"../dbcon.php"; 
$query_pag_data = "SELECT * from gal_report  ";
