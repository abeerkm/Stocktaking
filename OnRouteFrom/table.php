          ...
          while(($filesop = fgetcsv($handle, 1000, ",")) !== false)
                    {
                      ...
                      $txtqntb = $filesop[2];
                      $txtname = $filesop[3];
          $sql = "insert into Inventory_from_contractor (PROD, ORD, QNTB,Name) values
           ('".$txtprod."','".$txtord."','".$txtqntb."','".$txtname."')";
...
if(isset($_POST["drop"]))
{
  $sql = "delete from Inventory_from_contractor";
 ...
 // Append table with add row form on add new button click
  ...
  var index = $("table tbody tr:last-child").index();
        var row = '<tr>' +
            ...
            '<td><input type="text" class="form-control" name="ORD" id="ORD"></td>' +
...
<body>
    <div class="container"><p><h1 align="center">inventory from SubContractor </h1><div id="displaymessage"></div></p>
...
<?php 
include"../dbcon.php"; 
$query_pag_data = "SELECT * from inventory_from_contractor   ";
