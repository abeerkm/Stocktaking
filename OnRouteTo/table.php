...
if(isset($_POST["submit"]))
{
          ...
          $sql = "insert into Inventory_on_way (PROD, ORD, QNTB,Name) values
...
if(isset($_POST["drop"]))
{
  $sql = "delete from inventory_on_way";
...
<body>
    <div class="container"><p><h1 align="center">inventory on way to SubContractor </h1><div id="displaymessage"></div></p>
...
<?php 
include"../dbcon.php"; 
$query_pag_data = "SELECT * from inventory_on_way  ";
